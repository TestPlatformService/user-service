...
const (
	...
	Notifications_MarkNotificationAsRead_FullMethodName       = "/notification.Notifications/MarkNotificationAsRead"
)
...
func (c *notificationsClient) MarkNotificationAsRead(ctx context.Context, in *MarkNotificationAsReadReq, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, Notifications_MarkNotificationAsRead_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
